...
export default defineConfig({
  ...
  test: {
    ...
    // This package now owns a real-PostgreSQL suite
    // (test/receive-settle-step.pg.test.ts). Without the shared global setup, TEST_DATABASE_URL
    // is unset under `pnpm --filter @zucoins/generic-node test` and that suite would skip
    // silently — a green run proving nothing. Same wiring as apps/node and apps/platform.
