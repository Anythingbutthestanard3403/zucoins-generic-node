...
| [`wallet-money-capabilities.md`](wallet-money-capabilities.md) | Designate hubs/workers, fund hubs, bless existing dest (no re-mint), capability failure map (ZTR-1273 / ZTR-1306) |
