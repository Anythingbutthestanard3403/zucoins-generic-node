...
export const AXIS_DISPOSITIONS: readonly AxisDisposition[] = [
  ...
  },
  {
    ...
    closure:
      "DISCOVERY_PATH, all ten DISCOVERY_RESPONSE_FIELDS, and all five DISCOVERY_EXCLUSIONS resolve one-for-one against the api contract's discovery prose under snake_case normalisation, in the doc's own sequence. The `zupay` literal is retained per the compatibility-literal preservation rule.",
  },
  {
